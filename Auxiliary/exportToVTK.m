...
function exportToVTK (pts, values, filename, fieldname)
...
if (fid < 0)
    error ('exportToVTK: could not open file %s', filename);
end

fprintf (fid, str1, npts(1)-1, npts(2)-1, npts(3)-1, npts(1)-1, npts(2)-1, npts(3)-1, fieldclass, fieldname, fieldname, ncomp);
