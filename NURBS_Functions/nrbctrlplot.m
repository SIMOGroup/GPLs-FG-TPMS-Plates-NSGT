...
% And plot the control net
    for ii = 1:size (nurbs.coefs, 2)
      ...
      plot3 (coefs(1,:)./weights, coefs(2,:)./weights, coefs(3,:)./weights,'--','linewidth', 0.5, 'color', [0.47,0.67,0.19])
      plot3 (coefs(1,:)./weights, coefs(2,:)./weights, coefs(3,:)./weights,'c.','MarkerSize',12,'linewidth',3)
    end
